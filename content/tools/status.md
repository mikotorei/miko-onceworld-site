...
<div class="sim">
  ...
  <div class="row">
    <label class="pill">total <input id="basePointTotal" type="number" min="0" value="0"></label>
  ...
  <div class="row">
      <label class="pill">shaker <input id="shakerCount" type="number" min="0" value="0"></label>
    </div>
